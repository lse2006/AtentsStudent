...
namespace _01_Console
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"오크 {enemy.Name}가 타나났다.");
        ...
        private static void Test_Human()
        {
            ...
            //c1.TestPrintStatus(); //Character의 TestPrintStatus가 호출이 된다.(가상 함수가 아니라서)
            ...
            //  2.1 Attack을 할 때 30% 확률로 치명타가 터지게 만들어라(치명타는 대미지 2배)
            //시간

            //h1.TestPrintStatus();

            Human human1 = new Human(); //메모리 할당 완료(Instance화), 객체(Object) 생성 완료(인스턴스 생성 완료)
        ...
        public static void Test_Charactr()
        {
            Character human1 = new Character(); //메모리 할당완료(Instance화). 객체(Object) 생성완료. (객체의 인스턴스를 만들었다.)
            Character human2 = new Character("개굴맨맨");   // Character 타입으로 하나 더 만든 것. human1과 human2는 서로 다른 개체이다.

            //While (human1.IsDead != ture && human2.IsDead != true)
